    ...
    <div className="mt-20 w-full min-h-[60vh] flex-wrap  flex gap-5 flex-col items-center justify-center">
      {searchResults?.length !== 0 ? (
        searchResults?.map((user) => (
          <div key={user._id} className="w-full max-w-sm bg-white rounded-sm min-h-[70px] py-1 my-2 flex flex-row items-center md:justify-between justify-center flex-wrap gap-3 shadow-box ">
